...
/**
 * Ajoute des styles CSS pour la légende du graphique.
 * Cette fonction crée et insère un bloc de styles dans le `head` du document pour appliquer des
 * transformations CSS spécifiques à la légende du graphique.
 */
...
/**
 * Configure la structure des titres, sous-titres et sous-sous-titres dans un graphique.
 * Cette fonction supprime les anciens titres, puis crée et insère un titre principal, un sous-titre
 * et un sous-sous-titre dans le conteneur du graphique. Elle place ces éléments à des endroits spécifiques,
 * avant ou après les filtres selon leur disponibilité.
 */
