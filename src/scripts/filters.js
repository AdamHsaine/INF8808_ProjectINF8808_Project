...
/**
 * Fonction pour initialiser les filtres (compatibilité avec l'ancienne version).
 * Cette fonction appelle la nouvelle fonction `initializeHorizontalFilters`
 * tout en maintenant la compatibilité avec l'ancienne implémentation.
 *
 * @param {object} filters Les filtres à appliquer.
 * @param {Function} callback La fonction de rappel à exécuter après l'initialisation des filtres.
 */
