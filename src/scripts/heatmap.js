...
export function createHeatmap (csvUrl, containerId) {
  ...
  /**
   * Charge et affiche une heatmap des crimes pour une année et une saison données.
   * Les données sont extraites à partir d'un fichier CSV, puis transformées et affichées sous forme de heatmap.
   *
   * @param {number} year L'année pour laquelle afficher les données.
   * @param {string} season La saison sélectionnée, utilisée pour filtrer les mois à afficher.
   *        Cela devrait correspondre à l'une des clés de l'objet `seasons` (par exemple, "summer", "winter").
   */
