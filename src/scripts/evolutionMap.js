...
/**
 * Calcule les évolutions de criminalité entre deux années pour une catégorie donnée ou pour tous les crimes.
 *
 * Cette fonction calcule l'évolution du nombre de crimes entre une année de référence (baseYear)
 * et une année de comparaison (comparisonYear) pour chaque PDQ. L'évolution est calculée sous forme
 * de pourcentage en fonction de l'écart entre le nombre de crimes des deux années.
 *
 * @param {object} data Les données des PDQ, contenant des statistiques de criminalité par année et par catégorie.
 * @param {string} baseYear L'année de référence pour la comparaison.
 * @param {string} comparisonYear L'année de comparaison pour calculer l'évolution.
 * @param {string} category La catégorie de crime à comparer (ou 'all' pour tous les crimes).
 * @returns {object} Les données avec les évolutions calculées pour chaque PDQ, incluant un champ `evolution` pour chaque PDQ.
 */
...
/**
 * Masque (supprime) l'infobulle affichée lors du survol des éléments de la carte d'évolution.
 *
 * Cette fonction est appelée lorsque l'utilisateur déplace la souris en dehors des éléments
 * survolés, supprimant ainsi l'infobulle qui a été créée pour afficher les détails d'évolution.
 */
...
/**
 * Formate le nom de la catégorie en une chaîne de caractères.
 * Si la catégorie est invalide ou non spécifiée, renvoie 'Non spécifié'.
 *
 * @param {string} category Le nom de la catégorie à formater.
 * @returns {string} Le nom de la catégorie formaté, ou 'Non spécifié' si la catégorie est invalide.
 */
